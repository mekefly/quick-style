...
1. [涟漪效果](./ripples)
2. [涟漪效果 1](./ripples1)
3. [play 播放按钮动画（暂停与播放，dom 动画）](./button-play)
4. [下面是线的 input 组件](./input-line)
5. [todo 组件](./todo-list)
6. [创意的列表效果](./item-block)
7. [中规中矩的名片效果](./business-card)
8. [转盘加载动画](./loading)
9. [弹性的伸缩栏](./elastic-nav)
10. [抽拉式的图片显示](./expanding-cards)
11. [步骤进度条](./progress-steps)
12. [页面整体旋转的 menu 效果](./rotating-navigation-animation)
13. [隐藏式索小部件](./hidden-search-widget)
14. [模糊加载效果](./blurry-loading)
15. [滑动进入列表动画](./scroll-animation)
16. [选妹子还是选狗](./split-landing-page)
17. [文字逐个上漂的动画-50 项目 50 天第八天](./form-wave)
18. [声音](./sound-board)
19. [笑话](./dad-jokes)
